...
def createData():
    owog = simpledialog.askstring(
    "Input", "Овог нэрээ оруулна уу",
                                    parent=root)
    ner = simpledialog.askstring(
    "Input", "Нэрээ оруулна уу",
                                    parent=root)
    nas = simpledialog.askstring(
    "Input", "Нас оруулна уу",
                                    parent=root)
    huis = simpledialog.askstring(
    "Input", "Хүйс оруулна уу",
                                    parent=root)
...
menu.add_command(label="Бүртгэх", command=createData)
